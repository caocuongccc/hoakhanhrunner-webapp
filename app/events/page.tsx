...
export default function EventsPage() {
  ...
  const loadEvents = async () => {
    ...
    try {
      ...
      let query = supabase.from("events").select("*").gte("end_date", today); // Only show events that haven't ended
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-xl text-gray-600">
          Tham gia các sự kiện và thử thách cùng cộng đồng
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl shadow-md p-12 text-center">
          ...
          <p className="text-gray-500 text-lg">
            ...
            {filter === "ongoing" && "Không có sự kiện đang diễn ra"}
            {filter === "upcoming" && "Không có sự kiện sắp diễn ra"}
          </p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="relative h-48 bg-gradient-to-br from-blue-400 to-blue-600">
                    {event.image_url ? (
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <ActivityIcon className="h-20 w-20 text-white opacity-50" />
                      </div>
                    )}
                    ...
                    <div className="space-y-2 mt-auto">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <div className="text-blue-600 font-semibold">
                          {participantCounts[event.id] || 0} người tham gia
                        </div>
                      </div>
                    </div>
